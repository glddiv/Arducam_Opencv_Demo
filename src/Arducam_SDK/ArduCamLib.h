...
#include <stdint.h>
    ...
    unsigned int ArduCam_writeReg_32_32( ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32 val );
    unsigned int ArduCam_readReg_32_32( ArduCamHandle useHandle, Uint32 shipAddr, Uint32 regAddr, Uint32* pval );
